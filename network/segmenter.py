...
if not os.path.exists('/network/models.py'):
  os.system("jupyter nbconvert --to python network/models.ipynb")
...
class Segmenter:
    ...
    def visualise_output(self, nn_output, labels, resize_to):
        ...
        for class_idx in range(0, len(labels)):
        ...
        for i in range(0, len(labels)):
            ...
            (pt[0]+w+pad, pt[1]+h-1), font, 0.4, (50, 50, 50))
            pt = (pt[0], pt[1]+h+pad)
        return colour_map[..., ::-1]
